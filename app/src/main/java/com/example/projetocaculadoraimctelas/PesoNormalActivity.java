...
public class PesoNormalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textPeso = findViewById(R.id.textPeso2);
        textAltura = findViewById(R.id.textAltura2);
        textIMC = findViewById(R.id.textIMC2);
        textNivel = findViewById(R.id.textNivel2);
        textFraseApoio = findViewById(R.id.textFraseApoio2);
